...
<body class=" font-[dmsans] bg-lightBg text-black dark:bg-darkBg dark:text-white transition-colors duration-300 ">
  ...
  <section class="hero section flex justify-center items-center py-8 sm:py-16 px-2 sm:px-4">
    <div class="main w-full max-w-4xl text-center flex flex-col items-center gap-y-6 ">
      ...
      <p
        ...
        class="inder text-[12px] sm:text-[14px] mt-10 text-black">
      ...
      <h1
        ...
        data-aos-offset="500"
        data-aos-duration="1000"
        class="text-2xl sm:text-4xl lg:text-[36px] text-black font-bold leading-snug overflow-hidden poppins"
        data-aos="zoom-out">
      ...
      <p
        ...
        data-aos-offset="500"
        data-aos-duration="1000"
        class="inder text-[14px] sm:text-[16px] text-gray-500 max-w-3xl">
      ...
      <p
        ...
        data-aos-offset="500"
        data-aos-duration="1000"
        class="inder text-[14px] sm:text-[16px] text-gray-500 max-w-2xl">
      ...
      <div class="hero-button-grp flex flex-col items-center gap-3 mt-4 overflow-hidden">
        <span
          ...
          data-aos-offset="500"
          data-aos-duration="1000"
          class="inder text-[12px] sm:text-[14px] text-gray-500 font-medium">
      ...
      <p
        ...
        data-aos-offset="500"
        data-aos-duration="1000"
        class="inder text-[12px] sm:text-[14px] text-gray-500 max-w-2xl">
      ...
      <p
        ...
        data-aos-offset="500"
        data-aos-duration="1000"
        class="inder text-[12px] sm:text-[14px] text-gray-500 max-w-2xl mt-4">
  ...
  <section class="section py-8 sm:py-16 px-2 sm:px-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      ...
      <!-- First item -->
      <div data-aos-easing="linear" data-aos-duration="1000" data-aos="zoom-in-up"
        class="col1 bg-[#075E54] text-white h-80 md:col-span-2 flex p-5 justify-between rounded-lg">
        <div class="left w-[60%] flex flex-col justify-between">
          <div class="top">
            <h3 class="poppins"><span><i class="ri-bar-chart-horizontal-fill"></i></span> Whatsapp Automation</h3>
            <p class="text-[14px] font-[300] mt-3 inder">
              Automate WhatsApp messages for leads, reminders, and campaigns.
            </p>
          </div>
          <div class="bottom">
            <p class="text-[15px] flex items-center gap-2 inder">
      ...
      <!-- Second item -->
      <div data-aos-easing="linear" data-aos-duration="1000" data-aos="zoom-in-up"
        class="col3 p-5 bg-[#075E54] text-white h-80 flex flex-col justify-between rounded-lg">
        <div class="top">
          <h3 class="poppins"><span><i class="ri-lock-star-fill text-white"></i></span> Whatsapp Automation</h3>
          <p class="text-[14px] font-[300] mt-3 inder">
      ...
      <!-- Third item -->
      <div data-aos-easing="linear" data-aos-duration="1000" data-aos="zoom-in-up"
        class="col4 p-5 bg-[#075E54] text-white h-80 relative overflow-hidden rounded-lg">
        <h3 class="flex gap-2 poppins">
        ...
        <p class="text-[13px] font-[300] md:mt-2 inder">"Schedule" → "Conditions" → "Send message"</p>
      ...
      <!-- Fourth item -->
      <div data-aos-easing="linear" data-aos-duration="1000" data-aos="zoom-in-up"
        class="col5 p-5 bg-[#075E54] text-white h-80 flex justify-between flex-col gap-4 rounded-lg">
        <div class="top overflow-hidden">
          <h3 class="poppins"><span><i class="ri-book-shelf-line"></i></span> Media Library</h3>
          <p class="text-[14px] font-[300] mt-3 inder">
      ...
      <!-- Fifth item -->
      <div data-aos-easing="linear" data-aos-duration="1000" data-aos="zoom-in-up"
        class="col6 p-5 bg-[#075E54] text-black h-80 relative overflow-hidden rounded-lg">
        ...
        <div class="relative z-20">
          <h3 class="text-xl flex items-center gap-2 poppins">
      ...
      <div data-aos="zoom-in-up" data-aos-easing="linear" data-aos-duration="1000"
        ...
        <div class="bottom z-20">
          <h3 class="flex gap-2 font-[300] poppins">
            <img src="./assets/img/gpt.svg" alt="">OpenAI
          </h3>
          <h3 class="flex gap-2 font-[300] mt-2 poppins">
      ...
      <!-- Seventh item -->
      <div data-aos-easing="linear" data-aos-duration="1000" data-aos="zoom-in-up"
        class="p-6 bg-[#075E54] text-white rounded-lg h-80  relative overflow-hidden">
        <h3 class="flex items-center gap-2 text-lg font-light mb-2 poppins">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
          </svg>
          Data APIs
        </h3>
        <p class="text-sm font-light mb-6 inder">
  ...
  <section class="px-[50px]">
    <div class="text-white flex justify-center items-center flex-col gap-4 py-[2rem]">
      <p
        ...
        data-aos-duration="1000"
        class="text-black font-bold text-[1.5rem] md:text-[35.2px] poppins">Start building in seconds</p>
      <p
        data-aos="zoom-out"
        data-aos-easing="linear"
        data-aos-duration="1000"
        class="text-gray-600 text-[10px] text-center md:text-[15px] inder">Kickstart your next project with templates built by us and our community.</p>
      <div class="flex justify-center items-center gap-2 my-3">
        <button
          data-aos="fade-left"
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="bg-[#075E54] rounded-[5px] p-2 md:text-[13.2px] text-[10px] inder font-bold"> View all examples</button>
        <button
          data-aos="fade-right"
          data-aos-easing="linear"
          data-aos-duration="1000"
    ...
    <div class="text-white flex justify-center items-center gap-4 flex-wrap">
      <div
        ...
        <div class="py-[1rem] flex gap-2 flex-col px-4 mt-2">
          <p class="text-[17px] font-inder">Stripe Subscriptions Starter</p>
          <p class="text-[13.2px] font-inder">The all-in-one subscription starter kit for high- performance SaaS applications, powered by Stripe, Supabase, and Vercel.</p>
      ...
      <div
        ...
        <hr>
        <div class="py-[1rem] flex gap-2 flex-col px-4 mt-2">
          <p class="text-[17px] font-inder">Next.js Starter</p>
          <p class="text-[13.2px] font-inder">A Next.js App Router template configured with cookie-based auth using Supabase, TypeScript and Tailwind CSS.</p>
      ...
      <div
        ...
        <div class="py-[1rem] flex gap-4 flex-col px-4 mt-2">
          <p class="text-[17px] font-inder">AI Chatbot</p>
          <p class="text-[13.2px] font-inder">An open-source AI chatbot app template built with Next.js, the Vercel AI SDK, OpenAI, and Supabase.</p>
          <div class="flex gap-2 justify-start items-center mt-3"><span class="text-[12px]"> View Template</span><i class="ri-arrow-right-up-line"></i></div>
        </div>
      </div>
      ...
      <div
        ...
        <hr>
        <div class="py-[1rem] flex gap-4 flex-col px-4 mt-2">
          <p class="text-[17px] font-inder">LangChain + Next.js Starter</p>
          <p class="text-[13.2px] font-inder">Starter template and example use-cases for LangChain projects in Next.js, including chat, agents, and retrieval.</p>
          <div class="flex gap-2 justify-start items-center mt-3"><span class="text-[12px]"> View Template</span><i class="ri-arrow-right-up-line"></i></div>
        </div>
      </div>
      ...
      <div
        ...
        <hr>
        <div class="py-[1rem] flex gap-4 flex-col px-4 mt-2">
          <p class="text-[17px] font-inder">Flutter User Management</p>
          <p class="text-[13.2px] font-inder">Get started with Supabase and Flutter by building a user management app with auth, file storage, and database.</p>
          <div class="flex gap-2 justify-start items-center mt-3"><span class="text-[12px]"> View Template</span><i class="ri-arrow-right-up-line"></i></div>
        </div>
      </div>
      ...
      <div
        ...
        <hr>
        <div class="py-[1rem] flex gap-4 flex-col px-4 mt-2">
          <p class="text-[17px] font-inder">Expo React Native Starter</p>
          <p class="text-[13.2px] font-inder">An extended version of create-t3-turbo implementing authentication on both the web and mobile applications.</p>
          <div class="flex gap-2 justify-start items-center mt-3">
            <span class="text-[12px]"> View Template</span><i class="ri-arrow-right-up-line"></i>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex justify-center items-center flex-col md:gap-5 gap-2 my-[2rem] ">
      <div class="flex justify-center items-center flex-col">
        <p
          ...
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="poppins md:text-[34.2px] text-[1.3rem] text-black">Stay productive and manage your app</p>
        <p
          data-aos="zoom-out"
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="inder md:text-[34.2px] text-[1.3rem] text-black"> without leaving the dashboard</p>
      </div>
      <div class="overflow-hidden">
        <button
          ...
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="bg-[#075E54] inder rounded-[1rem] px-5 py-1 text-white md:text-[13px] text-[10px]">Table Editor</button>
        <button
          data-aos="zoom-in"
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="bg-[#075E54] inder rounded-[1rem] px-5 py-1 text-white md:text-[13px] text-[10px]">SQL Editor</button>
        <button
          data-aos="fade-right"
          data-aos-easing="linear"
          data-aos-duration="1000"
  ...
  <section class="">
    <div class="flex flex-col justify-center items-center gap-2 md:gap-5 mb-3 mt-3 overflow-hidden">
      <p
        ...
        data-aos-easing="linear"
        data-aos-duration="1000"
        class="inder text-[1.5rem] font-bold md:text-[32px] text-black">Join the community</p>
      <p
        data-aos="zoom-out"
        data-aos-easing="linear"
        data-aos-duration="1000"
        class="inder md:text-[16px] text-[10px] text-gray-600">Discover what our community has to say about their Supabase experience.</p>
        ...
        <div class="flex flex-nowrap gap-6" style="height: 524px;">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <img src="image/communities/Div [h-10].svg" alt="avatar" class="w-16 h-16 object-contain z-10" />
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close" class="w-[90%] h-[90%] object-contain" />
                  </div>
                </div>
                <span>@secondcoluser</span>
              </div>
              <p class="text-sm inder">
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <img src="image/communities/Div [h-10] (1).svg" alt="avatar" class="w-16 h-16 object-contain z-10" />
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close" class="w-[90%] h-[90%] object-contain" />
                  </div>
                </div>
              ...
              <p class="text-sm inder">"Shorter card."</p>
            </div>
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <img src="image/communities/Image (21).svg" alt="avatar" class="w-16 h-16 object-contain z-10" />
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close" class="w-[90%] h-[90%] object-contain" />
                  </div>
                </div>
              ...
              <p class="text-sm inder">
                "Another card content." "This card has a very very very very long text to test independent height behavior. It will grow bigger but other cards remain same!"
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Pariatur molestiae eaque, reiciendis autem et distinctio veritatis minus iure perferendis iste.
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <img src="image/communities/Image (16).svg" alt="avatar" class="w-16 h-16 object-contain z-10" />
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close" class="w-[90%] h-[90%] object-contain" />
                  </div>
                </div>
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <img src="image/communities/Image (20).svg" alt="avatar" class="w-16 h-16 object-contain z-10" />
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close" class="w-[90%] h-[90%] object-contain" />
                  </div>
                </div>
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <img src="image/communities/Image (18).svg" alt="avatar" class="w-16 h-16 object-contain z-10" />
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close" class="w-[90%] h-[90%] object-contain" />
                  </div>
                </div>
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Div [h-10] (1).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />

                  <!-- Corner icon (X icon in top-left) -->
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close"
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Div [h-10].svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Image (21).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Image (20).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />

                  <!-- Corner icon (X icon in top-left) -->
                  <div class="absolute -top-2 z-10 -left-2 w-6 h-6 bg-teal-800 rounded-full flex items-center justify-center">
                    <img src="image/communities/Div [absolute].svg" alt="close"
                      class="w-[90%] h-[90%] object-contain rounded-[50%]" />
                  </div>
                </div>
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Image (19).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Image (18).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Image (17).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                <div class="relative w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center shadow-lg">
                  <!-- Main avatar image inside the circle -->
                  <img src="image/communities/Image (16).svg" alt="avatar"
                    class="w-16 h-16 object-contain z-10" />
            ...
            <div class="bg-teal-800 p-4 rounded-xl text-white w-80 relative">
              ...
              <div class="flex items-center gap-2 mb-4">
                ...
                <span class="inder ">@secondcoluser3</span>
              </div>
  ...
  <section
    ...
    <div class="flex justify-center items-center flex-col gap-[1.5rem]">
      ...
      <p
        ...
        data-aos-easing="linear"
        data-aos-duration="1000"
        class="mdtext-[35px] text-[1.5rem] font-bold text-center text-black poppins">Build in a weekend,scale to millions</p>
      <div class="flex gap-2">
        <button
          data-aos="fade-left"
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="md:text-[15px] text-[10px] bg-[#075E54] rounded-[6px] border-[#075E54] p-3 inder text-white font-bold">Start your project</button>
        <button
          data-aos="fade-right"
          data-aos-easing="linear"
          data-aos-duration="1000"
          class="text-black border border-black rounded-[6px] p-3 md:text-[15px] inder text-[10px] font-bold">Request a demo</button>
      </div>
    </div>
  </section>
